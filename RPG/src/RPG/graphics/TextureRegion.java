...
public class TextureRegion implements ITexture , Cloneable
{
	...
	public TextureRegion(String string)
	{
		this(new Texture(string));
	}
	...
	public void set( SpriteCoordinates coord)
	{
		set(this.texture, coord.x, coord.y, coord.width , coord.height) ;
	}
